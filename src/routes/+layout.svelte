		...
		>
			...
			<svelte:fragment slot="trail">
				...
				<a href="https://www.linkedin.com/in/ville-valkonen-6741bb95/" target="_blank" rel="noreferrer">
					<svg class="linkedin svg-logo" height="20" viewBox="0 0 72 72" width="20" xmlns="http://www.w3.org/2000/svg">
				...
				<a href="https://github.com/ViltsuV" target="_blank" rel="noreferrer">
					<svg class="github svg-logo" height="20" viewBox="0 0 16 16" width="20" xmlns="http://www.w3.org/2000/svg">
						<g fill="white" fill-rule="evenodd">
							<path name="14-bg" fill="#333" d="M 8 1 C 12 1 15 4 15 8 c 0 4 -3 7 -7 7 C 4 15 1 12 1 8 c 0 -4 3 -7 7 -7 Z" />
