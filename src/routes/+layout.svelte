		...
		<AppBar>
			...
			<svelte:fragment slot="trail">
				...
				<a href="https://www.linkedin.com/in/ville-valkonen-6741bb95/" target="_blank" rel="noreferrer">
					<svg class="svg-logo" height="20" viewBox="0 0 72 72" width="20" xmlns="http://www.w3.org/2000/svg">
				...
				<a href="https://github.com/ViltsuV" target="_blank" rel="noreferrer">
					<svg class="svg-logo" height="20" viewBox="0 0 16 16" width="20" xmlns="http://www.w3.org/2000/svg">
